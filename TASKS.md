...
| 11.5 | Admin: Catalog Browser | Показать в админке реальные записи каталога tenant-а из БД с фильтрацией и базовыми полями (`name`, `category`, `measure`, `price`). | - | 11.4 | [ ] |
| 11.6 | Admin: Catalog CRUD | Добавить ручное создание, редактирование и удаление записей каталога tenant-а без CSV/Excel. | - | 11.5 | [ ] |
