...
| 6.2 | AI Service Interface | Обертка над OpenRouter. | Добавлен `services/api/src/services/ai.py` (LangChain ChatOpenAI), тест `services/api/tests/test_ai_service.py`. Ruff: ok. Pytest: ok. Commit: 1385d7a. | 2.1 | [x] |
