...
| 5.2 | UI: Schema Designer | CRUD для `catalog_schemas`. | Добавлены `services/admin/src/schema_designer.py`, обновлен `services/admin/src/main.py`, тест `services/admin/tests/test_schema_designer.py`. Ruff: ok. Pytest: ok. Commit: 67d3202. | 3.2 | [x] |
